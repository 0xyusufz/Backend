    ...
    <div className="Home">
      ...
      <div className="input-area">
        ...
        <form className="form-area" onSubmit={formHandler}>
            ...
            <input type="text" name="title" placeholder="Enter yout title" required className="uni"/>
            <input type="text" name="description" placeholder="Enter your description" className="uni" required/>
            </div>
